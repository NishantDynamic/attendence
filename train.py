...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="TRAIN DATA SET",font=("times new roman",30,"bold"),bg="Green",fg="white")
        title_lbl.place(x=0, y=0, width=1530,height=45)

        img_top=Image.open("shreesid.jpeg")
        ...
        img_bottom=Image.open("siddang.png")
