...
class Face_Recognition:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="FACE RECOGNITION", font=(
            "times new roman", 20, "bold"), bg="lightblue", fg="darkgreen")
        title_lbl.place(x=0, y=0, width=1530, height=35)

        # first image
        img_top = Image.open("siddang.png")
        ...
        # second image
        img_bottom = Image.open("facerecog.webp")
        ...
        # Button
        b1_1 = Button(f_lbl, text="Face Recognition", cursor="hand2", command=self.face_recog, font=("times new roman", 15, "bold"), bg="darkgreen", fg="yellow")
    ...
    def mark_attendance(self,i,r,n,d):
         with open("nishant.csv","r+",newline="\n") as f:
    ...
    def face_recog(self):
        def draw_boundray(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                my_cursor.execute("select Rool from student where student_ID="+str(id))
                ...
                # query = f"SELECT * FROM  student WHERE student_ID={id}".format(str(id))
                # print(query)
