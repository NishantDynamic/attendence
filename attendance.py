...
class Attendance:
    def __init__(self, root):
        ...
        Left_frame.place(x=2,y=1,width=660,height=1000)
        
        img_left=Image.open("stud1btn.jpg")
        ...
        atten_roll.grid(row=0,column=3,padx=8,pady=4,sticky=W)
        #Name
        ...
        btn_frame.place(x=1,y=300,width=715,height=35)
        ...
        update_button=Button(btn_frame,text="Export csv ",command=self.exportCsv,width=18,font=("times new roman",12,"bold"),bg="green",fg="white")
        update_button.grid(row=0,column=1)
        
        delete_button=Button(btn_frame,text="Update",width=17,font=("times new roman",12,"bold"),bg="green",fg="white")
        ...
        Right_frame.place(x=665,y=10,width=720,height=580)
